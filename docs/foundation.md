...
Institucional premium, com leitura editorial, superfícies claras, contraste elegante e pouca dependência de cards.
...
- `brand-cream`: fundo principal
- `brand-paper`: superfície de apoio
- `brand-ink`: texto/áreas institucionais
- `brand-muted`: conteúdo secundário
- `brand-line`: divisórias
- `brand-brass`: acento premium
- `brand-sand`: realce quente

### Direção de interface

- hero full-bleed com composição forte
- listas editoriais em vez de mosaico genérico
- uso restrito de acento para CTA e orientação
- linguagem visual orientada a confiança e clareza
